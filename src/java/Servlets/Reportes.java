...
public class Reportes extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<Reporte1> lista = g.listadoReporte1();
        request.setAttribute("ListadoReporte1", lista);
        RequestDispatcher req = getServletContext().getRequestDispatcher("/ListadoReporte1.jsp");
